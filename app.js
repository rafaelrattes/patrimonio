...
function addToCart(id){if(!cart.includes(id)){cart.push(id);saveCart();renderCart();updateCartCount();showToast("Peça adicionada ao carrinho");}else showToast("Essa peça já está no carrinho");}
