...
function objectHTML(x){
  if(x.image) {
    return `<img src="${x.image}" alt="${x.name}" style="width: 85%; height: 85%; object-fit: contain; filter: drop-shadow(12px 15px 10px rgba(0,0,0,.12));">`;
  }
